...
let AuthService = class AuthService {
    constructor(mysqlService, tokenService, logService) {
    ...
    async register(body) {
        ...
        return await this.mysqlService.query('INSERT INTO Users (Username, Passhash) VALUES (?, ?)', [body.username, hash]);
    }
    async verify(token) {
    ...
    async getUserByUsername(username) {
        const user = await this.mysqlService.query('SELECT * FROM Users WHERE Username = ?', [username]);
        return user[0];
    }
};

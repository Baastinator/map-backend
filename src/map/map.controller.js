...
let MapController = class MapController {
    constructor(mapService, tokenService, userService) {
...
], MapController.prototype, "getAll", null);
__decorate([
    (0, common_1.Get)('/:id'),
    ...
    __metadata("design:returntype", Promise)
], MapController.prototype, "getById", null);
__decorate([
    (0, common_1.Post)(''),
...
__decorate([
    ...
    __metadata("design:returntype", Promise)
], MapController.prototype, "uploadFile", null);
